...
def calculate_metrics(config, config_name, model, loader, modelling_folder, epoch, logger, device, subset, subevent, event):
...
if __name__ == "__main__":
    ...
    loader = data_pipeline.create_data_loaders(config=config, data_folder=args.data_folder, subset=args.subset, subevent=args.subevent, event=args.event)
